...
public class DataBaseUtility {
	...
	public static String fetchDataFromDataBase(Connection connection, String querry) throws SQLException {
	...
	public static void insertDataToDataBase(Connection connection, String querry) throws SQLException {
